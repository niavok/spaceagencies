...
import com.spaceagencies.client.graphics.ether.activities.MainActivity;
import com.spaceagencies.client.graphics.ether.activities.StatusActivity;
...
import com.spaceagencies.common.tools.Vec2;
...
import com.spaceagencies.i3d.I3dContext.ContextListener;
...
public class UiEngine implements Engine {
    ...
    public void init() {
        ...
        context.initCanvas("Space Agencies", 1280, 768, "graphics/icons/logo.png");
